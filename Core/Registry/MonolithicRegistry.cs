...
namespace CKAN
{
    ...
    public class MonolithicRegistry : IEnlistmentNotification, IRegistry
    {
        [JsonIgnore] private const int LATEST_REGISTRY_VERSION = 3;
        [JsonIgnore] private static readonly ILog log = LogManager.GetLogger(typeof (MonolithicRegistry));
        ...
        public void SetDownloadCounts(Repository _, SortedDictionary<string, int> counts)
        {
            if (counts != null)
            {
        ...
        {
            this.repositories = new SortedDictionary<string, Repository>();
        }
        ...
        [JsonConstructor]
        private MonolithicRegistry()
        {
        }

        public static MonolithicRegistry Empty()
        {
            return new MonolithicRegistry(
        ...
        public void SetAllAvailable(string _, IEnumerable<CkanModule> newAvail)
        {
        ...
        /// </summary>
        public void AddAvailable(string _, CkanModule module)
        {
            EnlistWithTransaction();
