...
namespace CKAN
{
    public abstract class RelationshipDescriptor : IEquatable<RelationshipDescriptor>
    {
        ...
        public abstract List<CkanModule> LatestAvailableWithProvides(IRegistry registry, GameVersionCriteria crit, IEnumerable<CkanModule> toInstall = null);
    ...
    public class ModuleRelationshipDescriptor : RelationshipDescriptor
    {
        ...
        public override List<CkanModule> LatestAvailableWithProvides(IRegistry registry, GameVersionCriteria crit, IEnumerable<CkanModule> toInstall = null)
        {
